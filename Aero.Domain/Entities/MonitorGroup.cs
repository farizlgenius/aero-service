...
public sealed class MonitorGroup : BaseDomain
{
    ...
    public MonitorGroup(int scpid, short driverId, string name, short nMpCount, List<MonitorGroupList> nMpList,int location,bool status) : base(location,status)
    {
        this.ScpId = scpid;
        MpgId = driverId;
