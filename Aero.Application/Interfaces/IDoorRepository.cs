...
public interface IDoorRepository : IBaseRepository<DoorDto,Door>
{
    ...
    Task<List<short>> GetLowestUnassignedNumberTwoByDeviceIdAsync(int max, int device);
    ...
    Task<IEnumerable<short>> GetAvailableReaderFromModuleIddAsync(int module);
    Task<IEnumerable<short>> GetAvailableOsdpAdddressAsync(int module);
    ...
    Task<IEnumerable<ModeDto>> GetDoorTypeAsync();
