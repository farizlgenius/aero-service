...
namespace HIDAeroService.Controllers
{
    ...
    public class eventController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<GenericDto<PaginationDto<List<EventDto>>>>> GetEvent([FromQuery] PaginationParams paginationParams)
        {
            ...
            GenericDto<PaginationDto<List<EventDto>>> p = new GenericDto<PaginationDto<List<EventDto>>>();
