...
{
    public sealed class Reader : BaseEntity,IDeviceId
    {
        ...
        public Reader(int module,int doorid,DoorDirection direction,short reader,short datadormat,short keypad,short leddrivermode,bool osdpflag,short baudrate,short discover,short tracing,short address,short secure,int scpid,int location) : base(location) 
        {
