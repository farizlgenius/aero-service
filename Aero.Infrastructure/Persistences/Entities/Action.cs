...
{
    public sealed class Action : BaseEntity,IDeviceId
    {
        ...
        public Action(int scp_id,short action_type, string action_type_detail,short arg1,short arg2,short arg3,short arg4,short arg5,short arg6,short arg7,string str_arg,short delay_time,short procedure_id,int location_id) : base(location_id)
        {
            this.scp_id = scp_id;
