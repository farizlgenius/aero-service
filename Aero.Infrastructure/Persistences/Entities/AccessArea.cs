...
namespace Aero.Infrastructure.Persistences.Entities
{
    public sealed class AccessArea : BaseEntity,IDbFunc<Aero.Domain.Entities.AccessArea>
    {
        ...
        public AccessArea(int scp_id,short driver_id,string name,short multi_occ,short access_control,short occ_control,short occ_set,short occ_max,short occ_up,short occ_down,short area_flag,int location_id) : base(location_id) 
        {
            this.scp_id = scp_id;
            this.area_id = driver_id;
            this.name = name;
