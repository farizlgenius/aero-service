...
namespace Aero.Infrastructure.Persistences.Entities
{
    public sealed class Strike : BaseEntity,IDeviceId
    {
        ...
        public Strike(int scpid,int moduleid,int doorid,short outputno,short relaymode,short offlinemode,short strikmax,short strikemin,short strikemode,int location) : base(location) 
        {
            this.scp_id = scpid;
