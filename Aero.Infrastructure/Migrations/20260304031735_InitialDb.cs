        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_device_driver_id", x => x.driver_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_timezone_driver_id", x => x.driver_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_area_driver_id", x => x.driver_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_module_device_device_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_monitor_group_driver_id", x => x.driver_id);
                    table.ForeignKey(
                        name: "FK_monitor_group_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_procedure_driver_id", x => x.driver_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_positions_location_locationid",
                        column: x => x.locationid,
                        principalTable: "location",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    antipassback_in = table.Column<short>(type: "smallint", nullable: false),
                    area_in_id = table.Column<short>(type: "smallint", nullable: false),
                    antipassback_out = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_control_point_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_monitor_point_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_action_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_trigger_driver_id", x => x.driver_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_access_level_component_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reader_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_request_exit_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_strike_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_device", x => new { x.device_id, x.user_id });
                    table.ForeignKey(
                        name: "FK_user_device_device_device_id",
                        column: x => x.device_id,
                        principalTable: "device",
                        principalColumn: "driver_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_device_credential", x => new { x.device_id, x.credential_id });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Devices", "" },
                    { 7, "door", "/door" },
                    { 8, "Card Holder", "/cardholder" },
                    { 9, "Access Level", "/level" },
                    { 10, "Access Area", "/area" },
                    { 11, "time", "" },
                    { 12, "trigger & procedure", "" },
                    { 13, "Reports", "" },
                    { 14, "Settings", "/setting" },
                    { 15, "Maps", "/map" },
                    { 16, "ControlPoint", "/control" },
                    { 17, "MonitorPoint", "/monitor" },
                    { 18, "monitor_group", "/monitorgroup" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 4, 3, 17, 33, 219, DateTimeKind.Utc).AddTicks(2492), "Shared location", true, "Shared", new DateTime(2026, 3, 4, 3, 17, 33, 219, DateTimeKind.Utc).AddTicks(2494) },
                    { 2, new DateTime(2026, 3, 4, 3, 17, 33, 219, DateTimeKind.Utc).AddTicks(2503), "Main location", true, "Main", new DateTime(2026, 3, 4, 3, 17, 33, 219, DateTimeKind.Utc).AddTicks(2503) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 4, 3, 17, 33, 232, DateTimeKind.Utc).AddTicks(670), true, 1, "No Access", new DateTime(2026, 3, 4, 3, 17, 33, 232, DateTimeKind.Utc).AddTicks(672) },
                    { 2, new DateTime(2026, 3, 4, 3, 17, 33, 232, DateTimeKind.Utc).AddTicks(675), true, 1, "Full Access", new DateTime(2026, 3, 4, 3, 17, 33, 232, DateTimeKind.Utc).AddTicks(684) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, (short)26, (short)16, (short)9, new DateTime(2026, 3, 4, 3, 17, 33, 236, DateTimeKind.Utc).AddTicks(3577), (short)0, (short)-1, (short)0, (short)0, (short)0, (short)1, (short)0, (short)0, true, 1, "26 bits (No Fac)", (short)0, (short)13, (short)0, (short)13, (short)13, new DateTime(2026, 3, 4, 3, 17, 33, 236, DateTimeKind.Utc).AddTicks(3578) });

            migrationBuilder.InsertData(
                table: "role",
                columns: new[] { "id", "created_date", "driver_id", "is_active", "location_id", "name", "updated_date" },
                values: new object[] { 1, new DateTime(2026, 3, 4, 3, 17, 33, 240, DateTimeKind.Utc).AddTicks(7028), (short)0, true, 1, "Administrator", new DateTime(2026, 3, 4, 3, 17, 33, 240, DateTimeKind.Utc).AddTicks(7028) });

            migrationBuilder.InsertData(
                table: "sub_feature",
                columns: new[] { "id", "feature_id", "name", "path" },
                values: new object[,]
                {
                    { 1, 5, "operator", "/operator" },
                    { 2, 5, "role", "/role" },
                    { 3, 6, "hardware", "/hardware" },
                    { 4, 6, "modules", "/modules" },
                    { 5, 11, "Timezone", "/timezone" },
                    { 6, 11, "holiday", "/holiday" },
                    { 7, 11, "interval", "/interval" },
                    { 8, 12, "trigger", "/trigger" },
                    { 9, 12, "procedure", "/action" },
                    { 10, 13, "transaction", "/transaction" },
                    { 11, 13, "Audit Trail", "/audit" }
                });

            migrationBuilder.InsertData(
                table: "timezone",
                columns: new[] { "id", "active_time", "created_date", "deactive_time", "driver_id", "is_active", "location_id", "mode", "name", "updated_date" },
                values: new object[] { 1, "", new DateTime(2026, 3, 4, 3, 17, 33, 232, DateTimeKind.Utc).AddTicks(7972), "", (short)1, true, 1, (short)1, "Always", new DateTime(2026, 3, 4, 3, 17, 33, 232, DateTimeKind.Utc).AddTicks(7974) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, 0, true, true, true, true, true },
                    { 3, 1, 0, true, true, true, true, true },
                    { 4, 1, 0, true, true, true, true, true },
                    { 5, 1, 0, true, true, true, true, true },
                    { 6, 1, 0, true, true, true, true, true },
                    { 7, 1, 0, true, true, true, true, true },
                    { 8, 1, 0, true, true, true, true, true },
                    { 9, 1, 0, true, true, true, true, true },
                    { 10, 1, 0, true, true, true, true, true },
                    { 11, 1, 0, true, true, true, true, true },
                    { 12, 1, 0, true, true, true, true, true },
                    { 13, 1, 0, true, true, true, true, true },
                    { 14, 1, 0, true, true, true, true, true },
                    { 15, 1, 0, true, true, true, true, true },
                    { 16, 1, 0, true, true, true, true, true },
                    { 17, 1, 0, true, true, true, true, true },
                    { 18, 1, 0, true, true, true, true, true }
                });

            migrationBuilder.InsertData(
                table: "operator",
                columns: new[] { "id", "created_date", "email", "first_name", "image", "is_active", "last_name", "middle_name", "password", "phone", "role_id", "title", "updated_date", "user_id", "user_name" },
                values: new object[] { 1, new DateTime(2026, 3, 4, 3, 17, 33, 242, DateTimeKind.Utc).AddTicks(89), "support@honorsupplying.com", "Administrator", "", true, "", "", "2439iBIqejYGcodz6j0vGvyeI25eOrjMX3QtIhgVyo0M4YYmWbS+NmGwo0LLByUY", "", 1, "Mr.", new DateTime(2026, 3, 4, 3, 17, 33, 242, DateTimeKind.Utc).AddTicks(90), "Administrator", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_access_level_component_device_id",
                table: "access_level_component",
                column: "device_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_control_point_device_id",
                table: "control_point",
                column: "device_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_monitor_group_device_id",
                table: "monitor_group",
                column: "device_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_monitor_point_device_id",
                table: "monitor_point",
                column: "device_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_request_exit_device_id",
                table: "request_exit",
                column: "device_id");
