    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_device_component", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_door_type", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    n_cfmt = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_companies_location_location_id",
                        column: x => x.location_id,
                        principalTable: "location",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_departments_location_location_id",
                        column: x => x.location_id,
                        principalTable: "location",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hardware_type_detail = table.Column<string>(type: "text", nullable: false),
                    ...
                    protocol_one_detail = table.Column<string>(type: "text", nullable: false),
                    ...
                    protocol_two_detail = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_device_scp_id", x => x.scp_id);
                    table.ForeignKey(
                        name: "FK_device_location_location_id",
                        column: x => x.location_id,
                        principalTable: "location",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    name = table.Column<string>(type: "text", nullable: false),
                    hol_id = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    led_mode = table.Column<short>(type: "smallint", nullable: false),
                    location_id = table.Column<int>(type: "integer", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
                    created_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_led_location_location_id",
                        column: x => x.location_id,
                        principalTable: "location",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_positions_location_location_id",
                        column: x => x.location_id,
                        principalTable: "location",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_timezone_timezone_id", x => x.timezone_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    area_id = table.Column<short>(type: "smallint", nullable: false),
                    name = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_area_area_id", x => x.area_id);
                    table.ForeignKey(
                        name: "FK_area_device_deviceid",
                        column: x => x.deviceid,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    model_detail = table.Column<string>(type: "text", nullable: false),
                    revision = table.Column<string>(type: "text", nullable: false),
                    serial_number = table.Column<string>(type: "text", nullable: false),
                    n_hardware_id = table.Column<int>(type: "integer", nullable: false),
                    n_hardware_id_detail = table.Column<string>(type: "text", nullable: false),
                    ...
                    n_enc_config_detail = table.Column<string>(type: "text", nullable: false),
                    n_enc_key_status = table.Column<short>(type: "smallint", nullable: false),
                    n_enc_key_status_detail = table.Column<string>(type: "text", nullable: false),
                    scp_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_module_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_monitor_group_mpg_id", x => x.mpg_id);
                    table.ForeignKey(
                        name: "FK_monitor_group_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_procedure_procedure_id", x => x.procedure_id);
                    table.ForeignKey(
                        name: "FK_procedure_device_deviceid",
                        column: x => x.deviceid,
                        principalTable: "device",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_days_in_week_interval_id",
                        column: x => x.id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    led_id = table.Column<int>(type: "integer", nullable: false),
                    r_led_id = table.Column<short>(type: "smallint", nullable: false),
                    on_color = table.Column<short>(type: "smallint", nullable: false),
                    off_color = table.Column<short>(type: "smallint", nullable: false),
                    on_time = table.Column<short>(type: "smallint", nullable: false),
                    off_time = table.Column<short>(type: "smallint", nullable: false),
                    repeat_count = table.Column<short>(type: "smallint", nullable: false),
                    beep_count = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_led_config", x => x.id);
                    table.ForeignKey(
                        name: "FK_led_config_led_led_id",
                        column: x => x.led_id,
                        principalTable: "led",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_user_positions_position_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_permissions_sources_source_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "text", nullable: false),
                    door_type = table.Column<int>(type: "integer", nullable: false),
                    ...
                    area_in_id = table.Column<short>(type: "smallint", nullable: true),
                    area_out_id = table.Column<short>(type: "smallint", nullable: true),
                    ...
                    mode = table.Column<short>(type: "smallint", nullable: false),
                    mode_detail = table.Column<string>(type: "text", nullable: false),
                    offline_mode = table.Column<short>(type: "smallint", nullable: false),
                    offline_mode_detail = table.Column<string>(type: "text", nullable: false),
                    default_mode = table.Column<short>(type: "smallint", nullable: false),
                    default_mode_detail = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_door_area_area_in_id",
                        column: x => x.area_in_id,
                        principalTable: "area",
                        principalColumn: "area_id");
                    table.ForeignKey(
                        name: "FK_door_area_area_out_id",
                        column: x => x.area_out_id,
                        principalTable: "area",
                        principalColumn: "area_id");
                    table.ForeignKey(
                        name: "FK_door_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    module_detail = table.Column<string>(type: "text", nullable: false),
                    output_no = table.Column<short>(type: "smallint", nullable: false),
                    relaymode = table.Column<short>(type: "smallint", nullable: false),
                    relaymode_detail = table.Column<string>(type: "text", nullable: false),
                    offlinemode = table.Column<short>(type: "smallint", nullable: false),
                    offlinemode_detail = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_control_point_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    input_mode_detail = table.Column<string>(type: "text", nullable: false),
                    ...
                    log_function_detail = table.Column<string>(type: "text", nullable: false),
                    monitor_point_mode = table.Column<short>(type: "smallint", nullable: false),
                    monitor_point_mode_detail = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_monitor_point_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    point_type_detail = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    action_type_detail = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_trigger_trigger_id", x => x.trigger_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_access_level", x => new { x.accesslevel_id, x.user_id });
                    table.ForeignKey(
                        name: "FK_user_access_level_access_level_accesslevel_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_additional", x => x.id);
                    table.ForeignKey(
                        name: "FK_user_additional_user_user_id",
                        column: x => x.user_id,
                        principalTable: "user",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_device", x => new { x.scp_id, x.user_id });
                    table.ForeignKey(
                        name: "FK_user_device_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_access_level_component_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_reader_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_reader_door_door_id",
                        column: x => x.door_id,
                        principalTable: "door",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_request_exit_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_request_exit_door_door_id",
                        column: x => x.door_id,
                        principalTable: "door",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    scp_id = table.Column<int>(type: "integer", nullable: false),
                    credential_id = table.Column<short>(type: "smallint", nullable: false),
                    id = table.Column<int>(type: "integer", nullable: false),
                    credentialid = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_device_credential", x => new { x.scp_id, x.credential_id });
                    table.ForeignKey(
                        name: "FK_device_credential_credential_credentialid",
                        column: x => x.credentialid,
                        principalTable: "credential",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_device_credential_device_scp_id",
                        column: x => x.scp_id,
                        principalTable: "device",
                        principalColumn: "scp_id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Single Reader", "Single Reader", 0 },
                    { 2, "Dual Reader", "Dual Reader", 1 },
                    { 3, "Turnstile Reader", "Turnstile Reader", 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "", "address 0", (short)0 },
                    { 2, "", "address 1", (short)17 },
                    { 3, "", "address 2", (short)34 },
                    { 4, "", "address 3", (short)51 }
                });
            ...
            migrationBuilder.InsertData(
                table: "scp_setting",
                columns: new[] { "id", "gmt_offset", "n_acr", "n_alvl", "n_area", "n_card", "n_cfmt", "n_cp", "n_hol", "n_mp", "n_mpg", "n_msp1_port", "n_proc", "n_sio", "n_transaction", "n_trgr", "n_tz" },
                values: new object[] { 1, (short)-25200, (short)64, (short)32000, (short)127, (short)200, (short)8, (short)388, (short)255, (short)615, (short)128, (short)3, (short)1024, (short)33, 60000, (short)1024, (short)255 });
            ...
            migrationBuilder.InsertData(
                table: "led_config",
                columns: new[] { "id", "beep_count", "led_id", "off_color", "off_time", "on_color", "on_time", "r_led_id", "repeat_count" },
                values: new object[,]
                {
                    { 1, (short)0, 1, (short)0, (short)0, (short)0, (short)0, (short)1, (short)0 },
                    { 2, (short)1, 1, (short)2, (short)3, (short)2, (short)3, (short)2, (short)0 },
                    { 3, (short)1, 1, (short)3, (short)3, (short)3, (short)3, (short)3, (short)0 },
                    { 4, (short)1, 1, (short)3, (short)3, (short)1, (short)3, (short)4, (short)0 },
                    { 5, (short)1, 1, (short)3, (short)3, (short)1, (short)3, (short)5, (short)0 },
                    { 6, (short)1, 1, (short)3, (short)3, (short)1, (short)3, (short)6, (short)0 },
                    { 7, (short)1, 1, (short)3, (short)3, (short)1, (short)3, (short)7, (short)0 },
                    { 8, (short)1, 1, (short)3, (short)3, (short)1, (short)3, (short)8, (short)0 },
                    { 9, (short)1, 1, (short)3, (short)3, (short)3, (short)3, (short)11, (short)0 },
                    { 10, (short)1, 1, (short)2, (short)3, (short)2, (short)3, (short)12, (short)0 },
                    { 11, (short)1, 1, (short)2, (short)3, (short)2, (short)3, (short)13, (short)0 },
                    { 12, (short)1, 1, (short)1, (short)3, (short)0, (short)3, (short)14, (short)0 },
                    { 13, (short)1, 1, (short)1, (short)3, (short)0, (short)3, (short)15, (short)0 },
                    { 14, (short)1, 1, (short)1, (short)3, (short)0, (short)3, (short)16, (short)0 },
                    { 15, (short)0, 2, (short)0, (short)0, (short)0, (short)0, (short)1, (short)0 },
                    { 16, (short)1, 2, (short)2, (short)3, (short)2, (short)3, (short)2, (short)0 },
                    { 17, (short)1, 2, (short)3, (short)3, (short)3, (short)3, (short)3, (short)0 },
                    { 18, (short)1, 2, (short)3, (short)3, (short)1, (short)3, (short)4, (short)0 },
                    { 19, (short)1, 2, (short)3, (short)3, (short)1, (short)3, (short)5, (short)0 },
                    { 20, (short)1, 2, (short)3, (short)3, (short)1, (short)3, (short)6, (short)0 },
                    { 21, (short)1, 2, (short)3, (short)3, (short)1, (short)3, (short)7, (short)0 },
                    { 22, (short)1, 2, (short)3, (short)3, (short)1, (short)3, (short)8, (short)0 },
                    { 23, (short)1, 2, (short)3, (short)3, (short)3, (short)3, (short)11, (short)0 },
                    { 24, (short)1, 2, (short)2, (short)3, (short)2, (short)3, (short)12, (short)0 },
                    { 25, (short)1, 2, (short)2, (short)3, (short)2, (short)3, (short)13, (short)0 },
                    { 26, (short)1, 2, (short)1, (short)3, (short)0, (short)3, (short)14, (short)0 },
                    { 27, (short)1, 2, (short)1, (short)3, (short)0, (short)3, (short)15, (short)0 },
                    { 28, (short)1, 2, (short)1, (short)3, (short)0, (short)3, (short)16, (short)0 },
                    { 29, (short)0, 3, (short)0, (short)0, (short)0, (short)0, (short)1, (short)0 },
                    { 30, (short)1, 3, (short)2, (short)3, (short)2, (short)3, (short)2, (short)0 },
                    { 31, (short)1, 3, (short)3, (short)3, (short)3, (short)3, (short)3, (short)0 },
                    { 32, (short)1, 3, (short)3, (short)3, (short)1, (short)3, (short)4, (short)0 },
                    { 33, (short)1, 3, (short)3, (short)3, (short)1, (short)3, (short)5, (short)0 },
                    { 34, (short)1, 3, (short)3, (short)3, (short)1, (short)3, (short)6, (short)0 },
                    { 35, (short)1, 3, (short)3, (short)3, (short)1, (short)3, (short)7, (short)0 },
                    { 36, (short)1, 3, (short)3, (short)3, (short)1, (short)3, (short)8, (short)0 },
                    { 37, (short)1, 3, (short)3, (short)3, (short)3, (short)3, (short)11, (short)0 },
                    { 38, (short)1, 3, (short)2, (short)3, (short)2, (short)3, (short)12, (short)0 },
                    { 39, (short)1, 3, (short)2, (short)3, (short)2, (short)3, (short)13, (short)0 },
                    { 40, (short)1, 3, (short)1, (short)3, (short)0, (short)3, (short)14, (short)0 },
                    { 41, (short)1, 3, (short)1, (short)3, (short)0, (short)3, (short)15, (short)0 },
                    { 42, (short)1, 3, (short)1, (short)3, (short)0, (short)3, (short)16, (short)0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_access_level_component_scp_id",
                table: "access_level_component",
                column: "scp_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_action_scp_id",
                table: "action",
                column: "scp_id");

            migrationBuilder.CreateIndex(
                name: "IX_area_deviceid",
                table: "area",
                column: "deviceid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_device_location_id",
                table: "device",
                column: "location_id");

            migrationBuilder.CreateIndex(
                name: "IX_device_credential_credentialid",
                table: "device_credential",
                column: "credentialid");

            migrationBuilder.CreateIndex(
                name: "IX_door_area_in_id",
                table: "door",
                column: "area_in_id");

            migrationBuilder.CreateIndex(
                name: "IX_door_area_out_id",
                table: "door",
                column: "area_out_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_led_location_id",
                table: "led",
                column: "location_id");

            migrationBuilder.CreateIndex(
                name: "IX_led_config_led_id",
                table: "led_config",
                column: "led_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_permissions_source_id",
                table: "permissions",
                column: "source_id");

            migrationBuilder.CreateIndex(
                name: "IX_positions_location_id",
                table: "positions",
                column: "location_id");

            migrationBuilder.CreateIndex(
                name: "IX_procedure_deviceid",
                table: "procedure",
                column: "deviceid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reader_scp_id",
                table: "reader",
                column: "scp_id");

            migrationBuilder.CreateIndex(
                name: "IX_request_exit_door_id",
                table: "request_exit",
                column: "door_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_access_level_user_id",
                table: "user_access_level",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "IX_user_additional_user_id",
                table: "user_additional",
                column: "user_id");
