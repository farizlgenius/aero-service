...
public class QTrigRepository(AppDbContext context) : IQTrigRepository
{
      ...
      public Task<IEnumerable<TriggerDto>> GetAsync()
      {
            throw new NotImplementedException();
      }

      public Task<TriggerDto> GetByComponentIdAsync(short componentId)
      {
            throw new NotImplementedException();
      }

      public Task<IEnumerable<TriggerDto>> GetByLocationIdAsync(short locationId)
      {
            throw new NotImplementedException();
      }
