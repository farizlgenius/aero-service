...
{
      public Task<int> AddAsync(Aero.Domain.Entities.Module data)
      {
            throw new NotImplementedException();
      }


      public Task<int> UpdateAsync(Aero.Domain.Entities.Module newData)
      {
            throw new NotImplementedException();
      }
    ...
    public async Task<Pagination<ModuleDto>> GetPaginationAsync(PaginationParamsWithFilter param, int location)
    {
      ...
      {
            return await context.module.AnyAsync(x => x.scp_id == device && x.sio_id == driver);
      }
