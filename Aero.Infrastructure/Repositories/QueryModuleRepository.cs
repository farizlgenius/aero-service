...
public sealed class QueryModuleRepository(AppDbContext context) : IQueryModuleRepository
{
  ...
  public async Task<ModuleDto> GetByComponentIdAsync(short componentId)
  {
    throw new NotImplementedException();
  }
