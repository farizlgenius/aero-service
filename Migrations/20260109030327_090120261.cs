...
{
    /// <inheritdoc />
    public partial class _090120261 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_sync = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()"),
                    uuid = table.Column<string>(type: "text", nullable: false),
                    component_id = table.Column<short>(type: "smallint", nullable: false),
                    location_id = table.Column<short>(type: "smallint", nullable: false),
                    is_active = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "card_format",
                columns: new[] { "id", "bits", "ch_ln", "ch_loc", "component_id", "created_date", "facility", "fc_ln", "fc_loc", "flags", "function_id", "ic_ln", "ic_loc", "is_active", "name", "offset", "pe_ln", "pe_loc", "po_ln", "po_loc", "uuid" },
            ...
            migrationBuilder.InsertData(
                table: "location",
                columns: new[] { "id", "component_id", "created_date", "description", "is_active", "location_name", "uuid" },
            ...
            migrationBuilder.InsertData(
                table: "role",
                columns: new[] { "id", "component_id", "created_date", "name" },
            ...
            migrationBuilder.InsertData(
                table: "accesslevel",
                columns: new[] { "id", "component_id", "is_active", "location_id", "name", "uuid" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "area",
                columns: new[] { "id", "access_control", "area_flag", "component_id", "created_date", "is_active", "location_id", "multi_occ", "name", "occ_control", "occ_down", "occ_max", "occ_set", "occ_up", "uuid" },
            ...
            migrationBuilder.InsertData(
                table: "operator",
                columns: new[] { "id", "component_id", "created_date", "email", "first_name", "image_path", "is_active", "last_name", "middle_name", "password", "phone", "role_id", "title", "user_id", "user_name", "uuid" },
            ...
            migrationBuilder.InsertData(
                table: "timezone",
                columns: new[] { "id", "active_time", "component_id", "deactive_time", "is_active", "location_id", "mode", "name", "uuid" },
                values: new object[] { 1, "", (short)1, "", true, (short)1, (short)1, "Always", "00000000-0000-0000-0000-000000000001" });
