...
namespace AeroService.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    e_sec = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    m_msp1_port = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_secrete_key", x => x.id);
                    table.ForeignKey(
                        name: "FK_secrete_key_key_pair_key_uuid",
                        column: x => x.key_uuid,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_accesslevel_component_id", x => x.component_id);
                    table.ForeignKey(
                        name: "FK_accesslevel_location_location_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cardholder_accesslevel", x => new { x.access_level_id, x.cardholder_id });
                    table.ForeignKey(
                        name: "FK_cardholder_accesslevel_accesslevel_access_level_id",
                        column: x => x.access_level_id,
                        principalTable: "accesslevel",
                        principalColumn: "component_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_cardholder_accesslevel_cardholder_cardholder_id",
                        column: x => x.cardholder_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    card_holderid = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cardholder_additional_cardholder_card_holderid",
                        column: x => x.card_holderid,
                        principalTable: "cardholder",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_credential_cardholder_cardholder_id",
                        column: x => x.cardholder_id,
                        principalTable: "cardholder",
                        principalColumn: "user_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_hardware_accesslevel", x => x.id);
                    table.ForeignKey(
                        name: "FK_hardware_accesslevel_accesslevel_access_levelid",
                        column: x => x.access_levelid,
                        principalTable: "accesslevel",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_hardware_accesslevel_hardware_hardware_mac",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    hardware_id = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "accesslevel_door_timezone",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_accesslevel_door_timezone", x => new { x.accesslevel_id, x.timezone_id, x.door_id });
                    table.ForeignKey(
                        name: "FK_accesslevel_door_timezone_accesslevel_accesslevel_id",
                        column: x => x.accesslevel_id,
                        principalTable: "accesslevel",
                        principalColumn: "component_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_accesslevel_door_timezone_door_door_id",
                        column: x => x.door_id,
                        principalTable: "door",
                        principalColumn: "component_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_accesslevel_door_timezone_timezone_timezone_id",
                        column: x => x.timezone_id,
                        principalTable: "timezone",
                        principalColumn: "component_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "card_format",
                columns: new[] { "id", "bits", "ch_ln", "ch_loc", "component_id", "created_date", "facility", "fc_ln", "fc_loc", "flags", "function_id", "ic_ln", "ic_loc", "is_active", "name", "offset", "pe_ln", "pe_loc", "po_ln", "po_loc", "updated_date", "uuid" },
                values: new object[] { 1, (short)26, (short)16, (short)9, (short)0, new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), (short)-1, (short)0, (short)0, (short)0, (short)1, (short)0, (short)0, true, "26 bits (No Fac)", (short)0, (short)13, (short)0, (short)13, (short)13, new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "00000000-0000-0000-0000-000000000001" });
            ...
            migrationBuilder.InsertData(
                table: "location",
                columns: new[] { "id", "component_id", "created_date", "description", "is_active", "location_name", "updated_date", "uuid" },
                values: new object[] { 1, (short)1, new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Main location", true, "Main", new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "00000000-0000-0000-0000-000000000001" });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "id", "gmt_offset", "m_msp1_port", "n_acr", "n_alvl", "n_area", "n_card", "n_cp", "n_hol", "n_mp", "n_mpg", "n_proc", "n_sio", "n_transaction", "n_trgr", "n_tz" },
                values: new object[] { 1, (short)-25200, (short)3, (short)64, (short)32000, (short)127, (short)200, (short)388, (short)255, (short)615, (short)128, (short)1024, (short)33, 60000, (short)1024, (short)255 });
            ...
            migrationBuilder.InsertData(
                table: "accesslevel",
                columns: new[] { "id", "component_id", "created_date", "is_active", "location_id", "name", "updated_date", "uuid" },
                values: new object[,]
                {
                    { 1, (short)1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, (short)1, "No Access", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "00000000-0000-0000-0000-000000000001" },
                    { 2, (short)2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, (short)1, "Full Access", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "00000000-0000-0000-0000-000000000001" }
                });

            migrationBuilder.InsertData(
                table: "area",
                columns: new[] { "id", "access_control", "area_flag", "component_id", "created_date", "is_active", "location_id", "multi_occ", "name", "occ_control", "occ_down", "occ_max", "occ_set", "occ_up", "updated_date", "uuid" },
                values: new object[] { 1, (short)0, (short)0, (short)-1, new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, (short)1, (short)0, "Any Area", (short)0, (short)0, (short)0, (short)0, (short)0, new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "00000000-0000-0000-0000-000000000001" });
            ...
            migrationBuilder.InsertData(
                table: "operator",
                columns: new[] { "id", "component_id", "created_date", "email", "first_name", "image_path", "is_active", "last_name", "middle_name", "password", "phone", "role_id", "title", "updated_date", "user_id", "user_name", "uuid" },
                values: new object[] { 1, (short)1, new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "support@honorsupplying.com", "Administrator", "", true, "", "", "2439iBIqejYGcodz6j0vGvyeI25eOrjMX3QtIhgVyo0M4YYmWbS+NmGwo0LLByUY", "", (short)1, "Mr.", new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Administrator", "admin", "00000000-0000-0000-0000-000000000001" });
            ...
            migrationBuilder.InsertData(
                table: "timezone",
                columns: new[] { "id", "active_time", "component_id", "created_date", "deactive_time", "is_active", "location_id", "mode", "name", "updated_date", "uuid" },
                values: new object[] { 1, "", (short)1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "", true, (short)1, (short)1, "Always", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "00000000-0000-0000-0000-000000000001" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_accesslevel_location_id",
                table: "accesslevel",
                column: "location_id");

            migrationBuilder.CreateIndex(
                name: "IX_accesslevel_door_timezone_door_id",
                table: "accesslevel_door_timezone",
                column: "door_id");

            migrationBuilder.CreateIndex(
                name: "IX_accesslevel_door_timezone_timezone_id",
                table: "accesslevel_door_timezone",
                column: "timezone_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cardholder_accesslevel_cardholder_id",
                table: "cardholder_accesslevel",
                column: "cardholder_id");

            migrationBuilder.CreateIndex(
                name: "IX_cardholder_additional_card_holderid",
                table: "cardholder_additional",
                column: "card_holderid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_credential_cardholder_id",
                table: "credential",
                column: "cardholder_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_hardware_accesslevel_access_levelid",
                table: "hardware_accesslevel",
                column: "access_levelid");

            migrationBuilder.CreateIndex(
                name: "IX_hardware_accesslevel_hardware_mac",
                table: "hardware_accesslevel",
                column: "hardware_mac");
