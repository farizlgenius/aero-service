...
{
    /// <inheritdoc />
    public partial class _061220251 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonitorGroupCommands", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "MonitorGroupTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonitorGroupTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    nMpCount = table.Column<short>(type: "smallint", nullable: false),
                    Uuid = table.Column<string>(type: "text", nullable: false),
                    ComponentId = table.Column<short>(type: "smallint", nullable: false),
                    MacAddress = table.Column<string>(type: "text", nullable: false),
                    LocationId = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonitorGroups", x => x.Id);
                    table.UniqueConstraint("AK_MonitorGroups_ComponentId", x => x.ComponentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Procedures_ComponentId", x => x.ComponentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceDesc = table.Column<string>(type: "text", nullable: false),
                    ...
                    TypeDesc = table.Column<string>(type: "text", nullable: false),
                    TranCode = table.Column<double>(type: "double precision", nullable: false),
                    ImagePath = table.Column<string>(type: "text", nullable: false),
                    TranCodeDesc = table.Column<string>(type: "text", nullable: false),
                    ExtendDesc = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "MonitorGroupLists",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PointType = table.Column<short>(type: "smallint", nullable: false),
                    PointTypeDesc = table.Column<string>(type: "text", nullable: false),
                    PointNumber = table.Column<short>(type: "smallint", nullable: false),
                    MonitorGroupId = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonitorGroupLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MonitorGroupLists_MonitorGroups_MonitorGroupId",
                        column: x => x.MonitorGroupId,
                        principalTable: "MonitorGroups",
                        principalColumn: "ComponentId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionTypeDesc = table.Column<string>(type: "text", nullable: false),
                    ...
                    StrArg = table.Column<string>(type: "text", nullable: false),
                    ProcedureId = table.Column<short>(type: "smallint", nullable: false),
                    Uuid = table.Column<string>(type: "text", nullable: false),
                    ComponentId = table.Column<short>(type: "smallint", nullable: false),
                    MacAddress = table.Column<string>(type: "text", nullable: false),
                    LocationId = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Actions_Procedures_ProcedureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceNumber = table.Column<short>(type: "smallint", nullable: false),
                    TranType = table.Column<short>(type: "smallint", nullable: false),
                    CodeMap = table.Column<short>(type: "smallint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Triggers_Procedures_ProcedureId",
                        column: x => x.ProcedureId,
                        principalTable: "Procedures",
                        principalColumn: "ComponentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransactionFlag_Transactions_TransactionId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "SIO diagnostics", "Module", (short)3 },
                    { 5, "SIO communication driver", "Module", (short)4 },
                    { 6, "SIO cabinet tamper", "Module", (short)5 },
                    { 7, "SIO power monitor", "Module", (short)6 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 12, (short)12, (short)12, "Procedure", "/action" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MonitorGroupLists_MonitorGroupId",
                table: "MonitorGroupLists",
                column: "MonitorGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_MonitorGroups_LocationId",
                table: "MonitorGroups",
                column: "LocationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionFlag_TransactionId",
