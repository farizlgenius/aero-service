    ...
    public sealed class Description
    {
        ...
        public static string GetTranCodeTypeCardFullDesc(short t)
        {
            switch (t)
            {
                ...
                case 10:
                    return "Reporting that this card is \"about to get access granted\" (expecting Command 329: Send Host Response host response)";
                case 11:
        ...
        public static short DecodeStatusTypeCoSNumber(short b)
        {
            byte codeValue = (byte)(b & 0x07);
